...
export function VibeBlock({ children }: { children: ReactNode }) {
  return (
    <div data-block className="vibe-block my-4 overflow-hidden rounded-t-lg border border-teal-400">
      <div className="flex items-center bg-teal-50 border-b border-teal-400 px-3 py-1.5">
