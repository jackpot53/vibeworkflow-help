...
export function FileBlock({ filename, children }: { filename: string; children: ReactNode }) {
  return (
    <div data-block className="file-block my-4 overflow-hidden rounded-t-lg border border-slate-400">
      <div className="flex items-center bg-slate-100 border-b border-slate-400 px-3 py-1.5">
